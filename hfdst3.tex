...
\section{Design}
\label{Design}
In this chapter we discuss how we built the neural network and why we chose for the network's architecture in specific. After explaining the neural network's architecture, we will have a look at how we translate this model working on plaintext pictures to a secure model using MPC.
